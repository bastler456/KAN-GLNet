...
def main(args):
    ...
    if args.optimizer == 'Adam':
        ...
        optimizer = Lion(classifier.parameters(), lr=args.learning_rate, betas=(0.9, 0.999), weight_decay=args.decay_rate)
    elif args.optimizer == 'SophiaG':
        optimizer = SophiaG(classifier.parameters(), lr=args.learning_rate, betas=(0.965, 0.99), weight_decay=args.decay_rate)
